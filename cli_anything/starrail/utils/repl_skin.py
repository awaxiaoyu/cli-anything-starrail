...
Usage:
    ...
    skin.print_banner()
    prompt_text = skin.prompt(project_name="my_config", modified=True)
    skin.success("Config saved")
    skin.error("File not found")
    skin.warning("Unsaved changes")
    skin.info("Running dungeon...")
    skin.status("Task", "Dungeon")
